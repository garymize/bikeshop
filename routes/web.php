...
Route::get('user/create',[UsersController::class, 'usercreate']);
Route::post('user/store',[UsersController::class, 'userstore']);
Route::post('user/show',[UsersController::class, 'usershow']);
