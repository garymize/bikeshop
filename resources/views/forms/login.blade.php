...
@section('mm-content')
    ...
    <div>
        ...
        <form method="POST" action="{{ route('authUser') }}">
            ...
            <input id="email" type='text' name="email" placeholder='' size='50' class='std-field-width' autocomplete="false" required/> <br>
            <label for='password' class='required innerLabel'>Password</label><br>        
            <input id="password" type='password' name="password" placeholder='' size='50' class='std-field-width' autocomplete="false" required/> <br><br>
