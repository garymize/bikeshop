...
@section('mm-content')
    ...
    <div>
        ...
        <form method="POST" action="{{ route('authUser') }}" autocomplete="off">
            ...
            <input id="password" type='password' name="password" placeholder='' size='50' class='std-field-width' autocomplete="new-password" required readonly onfocus="this.removeAttribute('readonly');" readonly onfocus="this.removeAttribute('readonly');"/> <br><br>
