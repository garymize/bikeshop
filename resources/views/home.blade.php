...
@section('content')
    ...
    <button class="IGSbutton IGSbutton-green IGSbutton-standard menuPointer" onClick="removeIGSMessage();"><img src="/images/ico-chat.svg" style="height: 30px;"> Clear Message</button>
