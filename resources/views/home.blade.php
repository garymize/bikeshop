...
<body>
    ...
    <button id="disableButtonButton" class="IGSbutton IGSbutton-green IGSbutton-standard menuPointer" onClick="disableButton();" style="width: 200px; margin-top: 105px;">Disable Button</button>
