...
@section('mm-content')
    ...
    <div>
        ...
        <input type='text' autocomplete="off" name="lastname" placeholder='' size='50' class='std-field-width inputDisabled' disabled="true" required/> <br>
        ...
        <input type='text' autocomplete="off" name="email" placeholder='' size='50' class='std-field-width inputDisabled' disabled="true" required/> <br>
        <label for='phone' class='required innerLabel'>Phone</label><br>        
        <input type='text' autocomplete="off" name="phone" placeholder='' size='50' class='std-field-width inputDisabled' disabled="true" required/> <br><br>
