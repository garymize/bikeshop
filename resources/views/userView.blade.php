...
@section('mm-content')
    ...
    <div>
        ...
        <input type='tel' autocomplete="off" value="{{ $data->phone }}" name="phone" placeholder='' size='50' pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class='std-field-width inputDisabled' disabled="true" required/> <br><br>
