...
@section('mm-content')
    ...
    <div>
        ...
        <div style='text-align: center;'>
            <input type='button' class='three-d-button' style='display:inline-block; margin-right:10px; margin-bottom: 10px; width: 100px; height: 41px; font-size: 26px; border-color:white; border-width: thin;' onclick="window.location='{{ route('userEdit', $data->email) }}'" value="Edit"/>
